...
منصة اختبارات ومسابقات قرآنية بأسلوب Kahoot: المعلّم ينشئ اختبارات قرآنية، والطلاب ينضمون للمسابقات المباشرة برقم الجلسة واسم مستعار — بلا حساب — أو يخوضون اختبارًا ذاتيًا بحساب طالب.
